...
$matches = Match::with(['season'])->get();
    ...
    return view('frontend.matches.index', compact('matches'));
}
function create()
{
...
$seasons = Season::pluck('name', 'id')->prepend(trans('global.pleaseSelect'), '');
    ...
    return view('frontend.matches.create', compact('seasons'));
}
...
$match->load('season');
    ...
    return view('frontend.matches.edit', compact('match', 'seasons'));
}
