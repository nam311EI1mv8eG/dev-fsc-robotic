...
$matchTeams = MatchTeam::with(['match', 'team'])->get();
    ...
    return view('admin.matchTeams.index', compact('matchTeams'));
}
function create()
{
...
$teams = Team::pluck('name', 'id')->prepend(trans('global.pleaseSelect'), '');
    ...
    return view('admin.matchTeams.create', compact('matches', 'teams'));
}
...
return redirect()->route('admin.match-teams.index');
...
$matchTeam->load('match', 'team');
    ...
    return view('admin.matchTeams.edit', compact('matchTeam', 'matches', 'teams'));
}
...
$matchTeam->load('match', 'team');
    ...
    return view('admin.matchTeams.show', compact('matchTeam'));
}
