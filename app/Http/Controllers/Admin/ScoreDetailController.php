...
$scoreDetails = ScoreDetail::with(['match'])->get();
    ...
    return view('admin.scoreDetails.index', compact('scoreDetails'));
}
function create()
{
...
$matches = Match::pluck('n_o', 'id')->prepend(trans('global.pleaseSelect'), '');
    ...
    return view('admin.scoreDetails.create', compact('matches'));
}
...
return redirect()->route('admin.score-details.index');
...
$scoreDetail->load('match');
    ...
    return view('admin.scoreDetails.edit', compact('matches', 'scoreDetail'));
}
...
$scoreDetail->load('match');
    ...
    return view('admin.scoreDetails.show', compact('scoreDetail'));
}
