                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('thidaurobotic_access')
                                        <a class="dropdown-item disabled" href="#">
                                            {{ trans('cruds.thidaurobotic.title') }}
                                        </a>
                                    @endcan
                                    @can('season_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.seasons.index') }}">
                                            {{ trans('cruds.season.title') }}
                                        </a>
                                    @endcan
                                    @can('match_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.matches.index') }}">
                                            {{ trans('cruds.match.title') }}
                                        </a>
                                    @endcan
                                    @can('score_detail_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.score-details.index') }}">
                                    ...
                                    @can('match_team_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.match-teams.index') }}">
